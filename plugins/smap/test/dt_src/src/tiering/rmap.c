...
#include "rmap.h"
 ...
 unsigned long vma_pgoff_address(pgoff_t pgoff, unsigned long nr_pages,
 ...
 */
 bool page_task_one(struct folio *folio, struct vm_area_struct *vma,
			  unsigned long address, void *arg)
{
 ...
 struct anon_vma *smap_folio_anon_vma(struct folio *folio)
{
 ...
 struct anon_vma *smap_rmap_walk_anon_lock(struct folio *folio,
...
out:
 ...
 void smap_rmap_walk_anon(struct folio *folio,
				struct rmap_walk_control *rwc, bool locked)
{
 ...
 void smap_rmap_walk_file(struct folio *folio,
				struct rmap_walk_control *rwc, bool locked)
{
...
lookup:
 ...
 void smap_rmap_walk(struct folio *folio, struct rmap_walk_control *rwc)
{
 ...
 void *smap_page_rmapping(struct page *page)
{
