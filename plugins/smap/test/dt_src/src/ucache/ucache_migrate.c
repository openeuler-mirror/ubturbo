...
#define NR_PAGES_TO_MIGRATE 10240
 ...
 DEFINE_IDR(nid_success_idr);

 struct lruvec *get_lruvec(int nid, pid_t pid)
{
 ...
 bool folio_should_skip(struct folio *folio)
{
...
out:
 ...
 void create_migrate_success(int nid, unsigned int nr_folios,
				   unsigned int nr_succeeded)
{
 ...
 void set_migrate_success_rate(int des_nid, unsigned int nr_folios,
				     unsigned int nr_succeeded)
{
