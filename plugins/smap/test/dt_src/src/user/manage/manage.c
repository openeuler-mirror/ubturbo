...
#define UPDATE_CRITICAL_ERR_COUNT 5
 ...
 struct ProcessManager g_processManager;

 char g_mmapTypeName[][MMAP_TYPE_STRING_LEN] = { "mmap_private", "mmap_shared" };
 char *g_nodePattern[LOCAL_NUMA_NUM] = { " N0=", " N1=", " N2=", " N3=" };
 ...
 uint32_t BuildAllLocalNumaMask(void)
{
 ...
 uint32_t BuildResidentLocalMask(const ProcessAttr *attr)
{
    if (!attr) {
        return 0;
    }
 ...
 uint32_t BuildAccountLocalMask(const ProcessAttr *attr, int remoteIndex)
{
 ...
 int ApplyManagedLocalObservation(ProcessAttr *attr, const ManagedLocalObservation *observation,
                                        bool fullReplacement)
{
 ...
 uint32_t GetManagedLocalRefreshPeriodMs(void)
{
 ...
 void AdvanceManagedLocalAffinityRefresh(ProcessAttr *attr)
{
 ...
 void ResetActcData(ActcData *actcData[], int len)
{
 ...
 void FreeProceccesAttr(ProcessAttr *attr)
{
    if (attr == NULL) {
        return;
    }
...
void LinkedListRemove(ProcessAttr **remove, ProcessAttr **head)
{
 ...
 unsigned long ProcessSmapsFile(pid_t pid, const char *targetLinePrefix, size_t prefixLength, size_t divisor)
{
 ...
 */
 int CmdlineHasSharedMem(const char *cmdline, int len)
{
...
/* Handle multi-NUMA VM scenario: VM with multiple local or remote NUMAs */
 void SetMultiNumaVmConfig(ProcessAttr *attr, ProcessParam *param, int nrLocalNuma)
{
    for (int i = 0; i < param->count; i++) {
 ...
 void MigratePagesToRemote(ProcessAttr *attr, int l2Index, const uint64_t pagesPerNuma[MAX_NODES], uint64_t pages)
{
 ...
 void ClearSingleRemoteTarget(ProcessAttr *attr, int l2Index, int nrLocalNuma)
{
 ...
 void AccountExistingRemotePagesByOldAccount(ProcessAttr *attr, int l2Index, uint64_t remotePages,
                                                   uint64_t oldTotal, int nrLocalNuma)
{
 ...
 void AccountExistingRemotePagesByLocalPages(ProcessAttr *attr, int l2Index,
                                                   ...
                                                   int nrLocalNuma)
{
 ...
 void AccountExistingRemotePages(ProcessAttr *attr, int l2Index, const uint64_t pagesPerNuma[MAX_NODES],
                                       uint64_t remotePages, int nrLocalNuma)
{
 ...
 void SetSingleRemoteTargetPages(ProcessAttr *attr, int l2Index, const uint64_t pagesPerNuma[MAX_NODES],
                                     ...
                                     const uint64_t pagesPerNuma[MAX_NODES])
{
 ...
 void ClearCompatibleProcessTargets(ProcessAttr *attr)
{
 ...
 void TargetConfigToProcessParam(const ProcessAttr *attr, const ProcessTargetConfig *config, ProcessParam *param)
{
    *param = (ProcessParam){
        .pid = attr->pid,
...
/* Generate compatibility runtime fields from the requested target. */
 int UpdateProcessMigrateConfig(ProcessAttr *attr, const ProcessTargetConfig *config,
                                      const ManagedLocalObservation *observation)
{
 ...
 bool IsZeroProcessTargetConfig(const ProcessTargetConfig *config)
{
    if (!config) {
        return false;
    }
 ...
 void UpdateAutoRemoveRemoteEmptyFlag(ProcessAttr *attr, const ProcessTargetConfig *config)
{
 ...
 int ValidateCandidateRemoteResidency(ProcessAttr *candidate, const ProcessTargetConfig *config,
                                            const ManagedLocalObservation *observation)
{
 ...
 int PrepareProcessTargetCandidate(ProcessAttr *candidate, const ProcessTargetConfig *config,
                                         const ManagedLocalObservation *observation)
{
 ...
 int SetProcessConfig(ProcessAttr *attr, ProcessParam *param)
{
 ...
 void SetGroupedProcessConfig(ProcessAttr *attr, pid_t pid, uint32_t nodeBitmap,
                                    const GroupMigrationPolicy *policy)
{
 ...
 void ResetGroupedPolicyRuntime(GroupMigrationPolicy *policy)
{
    if (!policy) {
        return;
    }
...
FILE *OpenNumaMaps(pid_t pid)
{
 ...
 int AddNumaPagesFromLine(char *line, uint64_t numaPages[MAX_NODES])
{
...
int GetPidNumaPagesFromNumaMaps(pid_t pid, uint64_t numaPages[MAX_NODES], bool onlyHuge)
{
 ...
 int CollectGroupedTargetEntries(GroupMigrationPolicy *policy, int targetNid,
                                       int groupIdx[MAX_GROUP_TARGET_ENTRY], int targetIdx[MAX_GROUP_TARGET_ENTRY])
{
 ...
 int InitGroupedTargetUsedPages(pid_t pid, GroupMigrationPolicy *policy, int targetNid, uint64_t residentPages)
{
...
int InitGroupedUsedPages(pid_t pid, GroupMigrationPolicy *policy, const uint64_t numaPages[MAX_NODES])
{
 ...
 void SetLocalByNumaMaps(char *line, uint32_t *nodeBitmap, bool hugeFlag)
{
    int i;
    int nrLocalNuma = GetNrLocalNuma();
    char *substr = NULL;
 ...
 int GetProcessNumaMapsObservation(pid_t pid, bool hugeFlag, uint32_t *residentLocalMask,
                                         uint64_t numaPages[MAX_NODES])
{
 ...
 void CalcActcStats(ProcessAttr *attr)
{
 ...
 uint32_t BuildPairCapacityLocalMask(const ProcessAttr *attr, int remoteIndex)
{
 ...
 void DistributePairAccount(ProcessAttr *attr, int remoteIndex, uint32_t localMask,
                                  ...
                                  uint32_t actualRemotePages)
{
 ...
 void RebuildPairAccount(ProcessAttr *attr, int remoteIndex, uint32_t actualRemotePages)
{
    uint32_t allLocalMask = BuildAllLocalNumaMask();
...
void CalibratePairAccount(ProcessAttr *attr)
{
 ...
 uint64_t PairRequestMulDiv(uint64_t value, uint64_t weight, uint64_t total)
{
    if (total == 0) {
        return 0;
    }
 ...
 void DistributePairRequestPages(uint64_t pages, const uint64_t weights[], int count, uint64_t allocation[])
{
    uint64_t weightTotal = 0;
 ...
 int ValidatePairRequestInput(const ProcessAttr *attr, const PairRequestContext *context)
{
 ...
 uint64_t BuildManagedTotalPages(const ProcessAttr *attr, int nrLocalNuma)
{
 ...
 void BuildRequestedRemotePages(const ProcessAttr *attr, const PairRequestContext *context,
                                      PairRequestSummary *summary)
{
 ...
 void BuildEffectiveRemotePages(const ProcessAttr *attr, const PairRequestContext *context,
                                      PairRequestSummary *summary)
{
 ...
 uint32_t BuildEligiblePairMask(const ProcessAttr *attr, const PairRequestContext *context, int remote)
{
 ...
 void PreservePairAccounts(const ProcessAttr *attr, const PairRequestContext *context,
                                 ...
                                 uint64_t pairRequests[LOCAL_NUMA_NUM][REMOTE_NUMA_NUM])
{
 ...
 void BuildLocalRemainingPages(const ProcessAttr *attr, const PairRequestContext *context,
                                     uint64_t pairRequests[LOCAL_NUMA_NUM][REMOTE_NUMA_NUM],
                                     uint64_t remainingPages[LOCAL_NUMA_NUM])
{
 ...
 uint32_t BuildActivePairMask(const ProcessAttr *attr, const PairRequestContext *context, int remote)
{
    return BuildEligiblePairMask(attr, context, remote) & attr->managedLocalState.residentLocalMask;
}

 void AllocateRemotePairRequest(const ProcessAttr *attr, const PairRequestContext *context, int remote,
...
enum {
 ...
 bool FindPairRequestAugmentingPath(uint64_t residual[PAIR_FLOW_NODE_COUNT][PAIR_FLOW_NODE_COUNT],
                                          int parent[PAIR_FLOW_NODE_COUNT])
{
 ...
 void CompletePairRequestFlow(uint64_t residual[PAIR_FLOW_NODE_COUNT][PAIR_FLOW_NODE_COUNT])
{
 ...
 int CompletePairRequestAllocation(const ProcessAttr *attr, const PairRequestContext *context,
                                         const PairRequestSummary *summary,
...
typedef enum {
 ...
 int ComparePairArbitrationEntry(const void *left, const void *right)
{
 ...
 uint64_t PairCapacityDemand(const PairArbitrationEntry *entry, PairCapacityPhase phase)
{
 ...
 bool PairMatchesCapacityPool(const PairArbitrationEntry *entry, int localNid, int remoteNid)
{
    return entry->target.remoteNid == remoteNid && (localNid < 0 || entry->target.localNid == localNid);
}

 void AddPairCapacityAllocation(PairArbitrationEntry *entry, PairCapacityPhase phase, uint64_t pages)
{
 ...
 */
 uint64_t AllocatePairCapacityPhase(PairArbitrationEntry entries[], size_t entryCount, int localNid,
                                          int remoteNid, uint64_t capacity, PairCapacityPhase phase)
{
 ...
 int RemoteCapacityToPages(uint64_t sizeMB, uint64_t pageSize, uint64_t *pages)
{
 ...
 int BuildPairCapacitySnapshot(const struct ProcessManager *manager,
                                     ...
                                     uint64_t sharedPages[REMOTE_NUMA_NUM], uint64_t totalPages[REMOTE_NUMA_NUM])
{
 ...
 void BuildPairRequestContext(const struct ProcessManager *manager,
                                    ...
                                    PairRequestContext *context)
{
 ...
 int CollectAllPairRequests(const struct ProcessManager *manager,
                                  const uint64_t privatePages[LOCAL_NUMA_NUM][REMOTE_NUMA_NUM],
                                  ...
                                  size_t entryCap, size_t *entryCount, bool migrateOnly)
{
 ...
 void ArbitrateAllPairCapacity(PairArbitrationEntry entries[], size_t entryCount, int nrLocalNuma,
                                     ...
                                     const uint64_t sharedCapacity[REMOTE_NUMA_NUM])
{
 ...
 void PublishPairCapacityResult(struct ProcessManager *manager, PairArbitrationEntry entries[], size_t entryCount,
                                      const uint64_t privateCapacity[LOCAL_NUMA_NUM][REMOTE_NUMA_NUM],
                                      const uint64_t totalCapacity[REMOTE_NUMA_NUM])
{
 ...
 int BuildPairArbitrationSnapshotLocked(struct ProcessManager *manager, PairArbitrationEntry entries[],
 ...
 * 返回: 成功返回0，失败返回负错误码
 */
 int DistributeActcData(ProcessAttr *attr, struct ProcessMemBitmap *pmb, ActcData *buf)
{
 ...
 */
 int ReadPidActcData(ProcessAttr *attr, struct ProcessMemBitmap *pmb)
{
 ...
 int FillPidData(ProcessAttr *attr, struct ProcessMemBitmap *pmb)
{
    int ret;
 ...
 int BuildBitmapBuf(size_t *len, char **buf)
{
    char *tmpBuf;
    size_t tmpLen;
 ...
 int ParseBitmapPid(struct ProcessMemBitmap *pmb, char *buf, size_t *offset)
{
    int ret;
 ...
 int ParseBitmapNrPages(struct ProcessMemBitmap *pmb, char *buf, size_t *offset)
{
    int ret;
 ...
 int ParseBitmap(size_t bufLen, char *buf, size_t *offset, struct ProcessMemBitmap *pmb)
{
 ...
 void NoAccountAlloc(int remoteNid, ProcessAttr *attr)
{
    int i;
    int nrLocalNuma = GetNrLocalNuma();
 ...
 void ClearNormalPidAccount(ProcessAttr *attr, int remoteNode, int nrLocalNuma)
{
    if (attr->state != PROC_MOVE) {
...
// returnFlag为true表示该NUMA处理完成，无需后续处理
 void CheckAccountAndNrPage(ProcessAttr *attr, bool returnFlag[REMOTE_NUMA_NUM])
{
    int i, j;
    int nrLocalNuma = GetNrLocalNuma();
    /**
 ...
 void CalNrPagesPerLocalNuma(ProcessAttr *attr)
{
    StrategyAttribute *sa = &attr->strategyAttr;
 ...
 * @param len:     比例数组长度
 */
 void CalRemoteAllocRatio(ProcessAttr *attr, int l2Index, double *ratio, int *len)
{
    int i;
    int nrLocalNuma = GetNrLocalNuma();
 ...
 * @param len:     比例数组长度
 */
 void CalRemoteAllocPages(ProcessAttr *attr, int l2Index, double *ratio, int ratioLen)
{
 ...
 void CalRemotePerLocalWithAccount(int l2Index, ProcessAttr *attr)
{
 ...
 void CalRemotePerLocal(ProcessAttr *attr)
{
    int i, j;
                                     ...
                                     uint32_t tmpMaxAllocNrPages[LOCAL_NUMA_NUM][REMOTE_NUMA_NUM])
{
 ...
 void CalAvailBorrowPage(uint32_t availPrivatePages[LOCAL_NUMA_NUM][REMOTE_NUMA_NUM],
                               uint32_t availSharedPages[REMOTE_NUMA_NUM])
{
 ...
 void AllocPrivatePage(uint32_t tmpMaxAllocNrPages[LOCAL_NUMA_NUM][REMOTE_NUMA_NUM],
                             uint32_t availPrivatePages[LOCAL_NUMA_NUM][REMOTE_NUMA_NUM])
{
 ...
 void AllocBorrowPage(uint32_t tmpMaxAllocNrPages[LOCAL_NUMA_NUM][REMOTE_NUMA_NUM],
                            uint32_t availPrivatePages[LOCAL_NUMA_NUM][REMOTE_NUMA_NUM],
                            uint32_t availSharedPages[REMOTE_NUMA_NUM])
{
    int i, j;
 ...
 void CalcMigrateNrPagesPerPIDMuiltNuma(void)
{
 ...
 int BuildAndFillBitmapBuf(size_t *len, char **buf)
{
    int ret;
...
bool IsAllL2NodePidInState(enum ProcessState state, int l2Node)
{
 ...
 void SetChangePidRemoteMsgPayload(int srcNid, int destNid, int *i, int maxProcessCnt,
                                         struct AccessAddPidPayload *payload)
{
 ...
 void ChangePidRemoteMemory(ProcessAttr *attr, int srcNodeIndex, int destNodeIndex, uint64_t memSize, int ratio)
{
    int nrLocalNuma = GetNrLocalNuma();
    int l1node;
 ...
 void ChangePidRemoteMemoryByNuma(ProcessAttr *attr, int srcNode, int destNode)
{
    if (GetRunMode() == WATERLINE_MODE) {
        for (int i = 0; i < g_processManager.nrLocalNuma; i++) {
...
int IsRemoteNumaMoveAllowed(int nid)
{
 ...
 bool IsRemoteTargetMigOutDone(ProcessAttr *attr, int remoteNid, uint64_t targetPages)
{
 ...
 bool GetRemoteTargetPages(ProcessAttr *attr, int remoteNid, uint64_t *targetPages)
{
    for (int i = 0; i < attr->remoteNumaCnt; i++) {
...
bool MigOutIsDone(ProcessAttr *attr, bool *isMultiNumaPid)
{
 ...
 void SetPayloadValue(struct AccessAddPidPayload *payload, struct MigPidRemoteNumaIoctlMsg *msg, int len)
{
