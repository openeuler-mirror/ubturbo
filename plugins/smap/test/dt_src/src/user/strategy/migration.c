...
int CollectNodeFreeSnapshot(bool hugePage, int nrLocalNuma, PairPlanContext *context)
{
 ...
 int ComparePairPlan(const void *left, const void *right)
{
 ...
 int FindPairPidBudget(const PairPidBudget pidBudgets[], size_t pidBudgetCnt, pid_t pid)
{
    int found = -1;
 ...
 bool IsPairPlanDirectionValid(const PairPlan *plan)
{
 ...
 ProcessAttr *FindPairPlanProcessLocked(struct ProcessManager *manager, pid_t pid)
{
 ...
 void ConsumeBucketPages(uint64_t buckets[FREQ_BUCKETS_SIZE], uint64_t pages, bool highestFirst)
{
 ...
 uint64_t CountPairSwapPages(const ProcessAttr *process, int localNid, int remoteNid, uint64_t localSelected,
                                   uint64_t remoteSelected)
{
 ...
 uint64_t CalcPairRemoteGuaranteeExtraSwap(const ProcessAttr *process, const PairPlan *plan,
                                                 ...
                                                 uint64_t baseSwapPages, uint64_t remainingSwapBudget)
{
 ...
 bool IsOnlyLocalForRemote(const PairPlan plans[], size_t planCnt, size_t current)
{
...
typedef struct {
 ...
 PairPlanMatrixStage *FindPairPlanMatrixStage(PairPlanMatrixStage stages[], size_t stageCnt, pid_t pid)
{
...
int BuildAllPairPlans(struct ProcessManager *manager, PairPlan plans[], size_t planCap, size_t *planCnt)
{
 ...
 void FreeMigList(struct MigList mList[MAX_NODES][MAX_NODES])
{
 ...
 void strategy_InitMigList(struct MigList mList[MAX_NODES][MAX_NODES], int pid)
{
    for (int from = 0; from < MAX_NODES; from++) {
        for (int to = 0; to < MAX_NODES; to++) {
            mList[from][to].nr = 0;
 ...
 int BuildMigrationMsg(ProcessAttr *process, struct MigrateMsg *mMsg, uint64_t *migratePage)
{
    ...
    strategy_InitMigList(migList, process->pid);
 ...
 uint64_t GetMigListSuccessPages(const struct MigList *list)
{
 ...
 void RefreshPairAccountMask(ProcessAttr *process, int localNid, int remoteIndex)
{
...
void UpdateMigResult(struct MigrateMsg *mMsg, struct ProcessManager *manager)
{
 ...
 void ResetGroupedSwapRuntimeLocked(ProcessAttr *process, bool freeze)
{
 ...
 void FreezeGroupedSwapLocked(struct ProcessManager *manager, pid_t pid)
{
 ...
 int FindGroupSwapPairStat(GroupSwapPairStat stats[], int statCnt, pid_t pid, int localNid, int remoteNid)
{
 ...
 int AddGroupSwapPairStat(GroupSwapPairStat stats[], int *statCnt, int maxStats, pid_t pid, int localNid,
                                int remoteNid)
{
 ...
 void AddGroupSwapCompPlan(GroupSwapCompPlan plans[], int *planCnt, pid_t pid, int from, int to, uint64_t need)
{
 ...
 int BuildGroupedSwapCompPlans(struct MigrateMsg *mMsg, struct ProcessManager *manager, GroupSwapCompPlan plans[],
                                     int *planCnt)
{
 ...
 int AppendCompMigResults(struct MigrateMsg *mMsg, const struct MigrateMsg *compMsg)
{
    if (compMsg->cnt == 0) {
        return 0;
    }
 ...
 uint64_t BuildCompMigListFromScan(ProcessAttr *process, GroupSwapCompPlan *plan, struct MigList *list)
{
 ...
 int BuildGroupedSwapCompMsg(struct ProcessManager *manager, GroupSwapCompPlan plans[], int planCnt,
                                   struct MigrateMsg *compMsg, int compPlanIdx[])
{
 ...
 void FreeCompMigMsg(struct MigrateMsg *compMsg)
{
 ...
 void FreezeFailedCompPlans(struct ProcessManager *manager, GroupSwapCompPlan plans[], int planCnt)
{
    EnvMutexLock(&manager->lock);
    for (int i = 0; i < planCnt; i++) {
 ...
 int RunGroupedSwapCompensation(struct ProcessManager *manager, struct MigrateMsg *mMsg,
...
int DoMigration(struct MigrateMsg *mMsg, struct ProcessManager *manager)
{
 ...
 int InitMigrateMsg(struct MigrateMsg *mMsg, struct ProcessManager *manager)
{
 ...
 int CleanStrategyAttribute(struct ProcessManager *manager)
{
    ProcessAttr *current;
    EnvMutexLock(&manager->lock);
 ...
 int PerformMigrationPreparation(struct ProcessManager *manager)
{
    int ret = 0;
 ...
 int SetMigrateThreadNum(struct MigrateMsg *mMsg, uint64_t migratePages, bool isForcedSingleThread)
{
    if (!mMsg) {
        return -EINVAL;
    }
  ...
  long CalcDurationUs(struct timeval start, struct timeval end)
{
    long seconds, micros;
 ...
 void PrintMigSpeed(struct ProcessManager *manager, uint64_t nr, struct timeval start, struct timeval end)
{
 ...
 void CalProcessNuma(StrategyAttribute *strategyAttr)
{
...
int CompareMigOut(const void *b, const void *a)
{
 ...
 void NumaSwapMemPool(ProcessAttr *current)
{
 ...
 void ApplyUbBwStop(ProcessAttr *current, struct ProcessManager *manager)
{
 ...
 void NumaMigReduceDeal(ProcessAttr *current)
{
 ...
 ProcessAttr *FindMigrationCandidateLocked(struct ProcessManager *manager, pid_t pid)
{
 ...
 int PreMigration(struct ProcessManager *manager, struct MigrateMsg *mMsg, uint64_t *migratePages)
{
    int ret;
    ProcessAttr *current;
...
OUT:
 ...
 void PostMigration(struct ProcessManager *manager, struct MigrateMsg *mMsg)
{
 ...
 int PerformMigration(struct ProcessManager *manager)
{
    int ret;
 ...
 int UpdateScanTime(ProcessAttr *process)
{
 ...
 void UpdateScene(struct ProcessManager *manager)
{
    EnvMutexLock(&manager->lock);
    ProcessAttr *current = manager->processes;
    while (current) {
  ...
  void HandleHighScan(ProcessAttr *current)
{
 ...
 int HandleScene(ThreadCtx *ctx)
{
 ...
 void UpdateAllProcessScanTime(ThreadCtx *ctx)
{
    int ret;
    struct ProcessManager *manager = ctx->processManager;
 ...
 void RestoreProcessScanTime(ThreadCtx *ctx)
{
    struct ProcessManager *manager = ctx->processManager;
 ...
 void UpdatePeriodFromConfig(ThreadCtx *ctx)
{
 ...
 void UpdateMigrateModeAndScanCpu(void)
{
