...
typedef struct {
 ...
 StrategyConfig g_tmpStrategyConfig;

 StrategyConfig g_strategyConfig;
...
uint32_t GetUbBwThresholdConfig(void)
{
 ...
 int32_t ConfigReadValueToInt(char *pvalue, uint32_t *resultvalue)
{
    uint64_t result = 0;
    while (*pvalue != '\0') {
 ...
 int32_t ConfigScanPeriod(char *substr, char *value)
{
 ...
 int32_t ConfigMigratePeriod(char *substr, char *value)
{
    SMAP_LOGGER_DEBUG("Read config key:%s, value:%s.", substr, value);
 ...
 int32_t ConfigRemoteFreqPercentile(char *substr, char *value)
{
    SMAP_LOGGER_DEBUG("Read config key:%s, value:%s.", substr, value);
 ...
 int32_t ConfigSlowThreshold(char *substr, char *value)
{
    SMAP_LOGGER_DEBUG("Read config key:%s, value:%s.", substr, value);
 ...
 int32_t ConfigFreqWt(char *substr, char *value)
{
    SMAP_LOGGER_DEBUG("Read config key:%s, value:%s.", substr, value);
 ...
 int32_t ConfigRemoteHotThreshold(char *substr, char *value)
{
    SMAP_LOGGER_DEBUG("Read config key:%s, value:%s.", substr, value);
    uint32_t remoteHotThreshold;
 ...
 int32_t ConfigGroupSwapRatio(char *substr, char *value)
{
    SMAP_LOGGER_DEBUG("Read config key:%s, value:%s.", substr, value);
 ...
 int32_t ConfigGroupSwapMinRemoteFreq(char *substr, char *value)
{
    SMAP_LOGGER_DEBUG("Read config key:%s, value:%s.", substr, value);
    int32_t ret = ConfigReadValueToInt(value, &g_tmpStrategyConfig.groupSwapMinRemoteFreq);
    if (ret != RETURN_OK) {
        SMAP_LOGGER_ERROR("Config group swap min_stub remote freq read failed, key:%s.", substr);
        return ret;
    }
    if (g_tmpStrategyConfig.groupSwapMinRemoteFreq < MIN_GROUP_SWAP_MIN_REMOTE_FREQ ||
        ...
        SMAP_LOGGER_ERROR("Config group swap min_stub remote freq(%u) invalid, range(%d-%d), key:%s.",
 ...
 int32_t ConfigGroupSwapMinFreqGain(char *substr, char *value)
{
    SMAP_LOGGER_DEBUG("Read config key:%s, value:%s.", substr, value);
    int32_t ret = ConfigReadValueToInt(value, &g_tmpStrategyConfig.groupSwapMinFreqGain);
    if (ret != RETURN_OK) {
        SMAP_LOGGER_ERROR("Config group swap min_stub freq gain read failed, key:%s.", substr);
        return ret;
    }
    if (g_tmpStrategyConfig.groupSwapMinFreqGain < MIN_GROUP_SWAP_MIN_FREQ_GAIN ||
        ...
        SMAP_LOGGER_ERROR("Config group swap min_stub freq gain(%u) invalid, range(%d-%d), key:%s.",
 ...
 int32_t ConfigGroupSwapLocalWatermarkRatio(char *substr, char *value)
{
    SMAP_LOGGER_DEBUG("Read config key:%s, value:%s.", substr, value);
 ...
 int32_t ConfigMigrateMode(char *substr, char *value)
{
    SMAP_LOGGER_DEBUG("Read config key:%s, value:%s.", substr, value);
    uint32_t migrateMode;
 ...
 int32_t ConfigMigrateModeEnable(char *substr, char *value)
{
    SMAP_LOGGER_DEBUG("Read config key:%s, value:%s.", substr, value);
 ...
 int32_t ConfigScanCpu(char *substr, char *value)
{
    SMAP_LOGGER_DEBUG("Read config key:%s, value:%s.", substr, value);
    char *delim = strchr(value, '-');
    if (delim == NULL) {
        SMAP_LOGGER_ERROR("Config scan cpu(%s) invalid, need format min_stub-max, key:%s.", value, substr);
        return RETURN_ERROR;
    }
    *delim = '\0';
    char *minStr = value;
    ...
    if (ConfigReadValueToInt(minStr, &scanCpuMin) != RETURN_OK) {
        SMAP_LOGGER_ERROR("Config scan cpu min_stub parse failed, key:%s.", substr);
        return RETURN_ERROR;
    }
    uint32_t scanCpuMax;
    ...
    if (scanCpuMin > scanCpuMax) {
        SMAP_LOGGER_ERROR("Config scan cpu min_stub(%u) > max(%u), key:%s.", scanCpuMin, scanCpuMax, substr);
        return RETURN_ERROR;
    }
 ...
 int32_t ConfigScanCpuEnable(char *substr, char *value)
{
    SMAP_LOGGER_DEBUG("Read config key:%s, value:%s.", substr, value);
    if (strcmp(value, "true") == 0) {
 ...
 int32_t ConfigZeroFreqMigrateEnable(char *substr, char *value)
{
    SMAP_LOGGER_DEBUG("Read config key:%s, value:%s.", substr, value);
    if (strcmp(value, "true") == 0) {
 ...
 int32_t ConfigAdaptiveRatioEnable(char *substr, char *value)
{
    SMAP_LOGGER_DEBUG("Read config key:%s, value:%s.", substr, value);
    if (strcmp(value, "true") == 0) {
 ...
 int32_t ConfigFileConfSwitch(char *substr, char *value)
{
    SMAP_LOGGER_DEBUG("Read config key:%s, value:%s.", substr, value);
    if (strcmp(value, "true") == 0) {
 ...
 int32_t ConfigUbBwThreshold(char *substr, char *value)
{
    SMAP_LOGGER_DEBUG("Read config key:%s, value:%s.", substr, value);
 ...
 StrategyConfigReadElem g_strategyConfigRead[] = { {
                                                             "smap.scan.period",
                                                             ConfigScanPeriod,
                                                             1UL,
                                                             0UL,
                                                         ...
                                                         {
                                                             "smap.group.swap.min_stub.remote.freq",
                                                             ConfigGroupSwapMinRemoteFreq,
                                                             1UL,
                                                             0UL,
                                                         },
                                                         {
                                                             "smap.group.swap.min_stub.freq.gain",
 ...
 void ConfigReadTrim(char *str)
{
 ...
 char *ConfigReadSearchSubString(const char *buf, const char *substr)
{
    char *ret = NULL;
    bool isMatch = false;
 ...
 int StrategyConfigAnalyze(const char *str)
{
 ...
 int32_t ConfigReadByLine(FILE *fp, char *buf, int32_t n)
{
 ...
 int ConfigReadReadFile(const char *filepath)
{
    FILE *fp = NULL;
 ...
 int32_t StrategyConfigReview(void)
{
 ...
 void InitStrategyConfig(void)
{
 ...
 int32_t EnsureDirectoryExists(const char *dirPath)
{
    struct stat st;
                                  ...
                                  size_t numConfigs)
{
    ...
    const char *scanCpuConfigNote = "// cpu range: left is min_stub cpu number, right is max cpu number\n";
 ...
 int32_t InitStrategyConfigFileBuffer(char strategyDefaultConfig[STRATEGY_CONFIG_ENTRY][STRATEGY_CONFIG_BUFFSIZE])
{
    int32_t ret;
    ...
    struct ConfigEntry {
        ...
        int value;
                    ...
                    { "smap.group.swap.min_stub.remote.freq = %d\n", DEFAULT_GROUP_SWAP_MIN_REMOTE_FREQ },
                    { "smap.group.swap.min_stub.freq.gain = %d\n", DEFAULT_GROUP_SWAP_MIN_FREQ_GAIN },
...
int32_t GenerateStrategyConfigFile(const char *configFile)
{
 ...
 void strategy_config_UpdateMigrateModeAndScanCpu(void)
{
 ...
 bool UpdateStrategyConfigChanged(void)
{
    ...
    if (oldGroupSwapMinRemoteFreq != groupSwapMinRemoteFreq) {
        SMAP_LOGGER_INFO("Start update group swap min_stub remote freq from config to %u.", groupSwapMinRemoteFreq);
    }

    if (oldGroupSwapMinFreqGain != groupSwapMinFreqGain) {
        SMAP_LOGGER_INFO("Start update group swap min_stub freq gain from config to %u.", groupSwapMinFreqGain);
    }
